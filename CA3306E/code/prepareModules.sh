...
mkdir -p /media/pi/bigdata/k_tmp/linux
wget https://raw.github.com/raspberrypi/firmware/$FV/extra/git_hash -O /media/pi/bigdata/k_tmp/git_hash
wget https://raw.github.com/raspberrypi/firmware/$FV/extra/Module.symvers -O /media/pi/bigdata/k_tmp/Module.symvers
HASH=`cat /media/pi/bigdata/k_tmp/git_hash`
wget -c https://github.com/raspberrypi/linux/tarball/$HASH -O /media/pi/bigdata/k_tmp/linux.tar.gz
cd /media/pi/bigdata/k_tmp
